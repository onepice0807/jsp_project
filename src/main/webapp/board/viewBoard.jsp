...
<body>
	...
	<div class="container">
		...
		<c:if test="${requestScope.uploadFile != null }">
			<div class="mb-3">
				...
				<img src='${contextPath }/${requestScope.uploadFile.newFeileName }' />
		...
		<div class="mb-3">
			<c:choose>
				<c:when test="${sessionScope.loginUser != null }">
					...
					<button type="button" class="btn btn-success"
						onclick="location.href='replysBoard.jsp?no=${requestScope.board.no }&ref=${requestScope.board.ref }&step=${requestScope.board.step }&reforder=${requestScope.board.reforder }';">답글달기</button>
				</c:when>
			...
			<button type="button" class="btn btn-info"
				onclick="location.href='listAll.bo';">목록으로가기</button>
		</div>
	</div>
	...
	<!-- The Modal -->
	<div class="modal" id="delModal" style="disply: none;">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal body -->
				<div class="modal-body">${requestScope.board.no }번글삭제하시겠습니까?</div>
	...
	<script src="https://kit.fontawesome.com/7ebe0c9b43.js"
