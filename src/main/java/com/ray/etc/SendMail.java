...
public class SendMail {
	...
	public static void sendMail(String userMailAddr, String code) throws AddressException, MessagingException {
		...
		String message = "miniproj.com 회원 가입을 환영합니다. 회원 가입 화면에서 인증번호 : " + 
				code + "를 입력하시고 코드 확인 버튼을 눌러 회원가입을 완료하세요.";
		...
		props.put("mail.smtp.port", "465"); // smtp 포트번호
		...
		System.out.println(mailSession.toString());
 		...
 		if (mailSession != null) {
 			...
 			mime.setFrom(new InternetAddress("ray0807@naver.com")); // 보내는 메일 주소
